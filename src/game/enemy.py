...
class Enemy:
    ...
    def __init__(self, name = "Enemy", hit_points = 0, lives = 1):
        ...
        self.starting_health = hit_points
        self._lives = lives
        self._alive = True
    ...
    def take_damage(self, damage):
        ...
        if remaining_points >= 0:
            ...
            self._lives -= 1
            if self._lives > 0:
                print("{0._name} lost a life. {0._lives} remaining".format(self))
                self._hit_points = self.starting_health
            else:
    ...
    def __str__(self):
        return "Name: {0._name}, Lives: {0._lives}, HP: {0._hit_points}".format(self)
